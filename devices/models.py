...
class Device(models.Model):
    ...
    hardware_version = models.CharField(max_length=150,null=True, blank=True)
    ...
    config = models.CharField(max_length=150,null=True, blank=True)
    fail_station = models.CharField(max_length=150,null=True, blank=True)
    failure_mode = models.CharField(max_length=150,null=True, blank=True)  # 具体fail的测项
...
class OperationRecord(models.Model):
    ...
    task = models.ForeignKey('workflows.DeviceTask', on_delete=models.SET_NULL, null=True, blank=True)
